...
class MetricsConsumer:
    ...
    def __init__(self, config, loop, consumer):
        ...
        :param consumer: Coroutine callback for received message
        """
    ...
    async def __aenter__(self):
        """
        Connect Consumer to Kafka service
        """
    ...
    async def __aexit__(self, exc_type, exc, tb):
        """
        Disconnect Consumer form Kafka service
        """
    ...
    async def consume(self):
        """
        Start to consume json messages
        """
